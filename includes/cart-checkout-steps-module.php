    ...
    <div class="panel-group accordion" id="cartPaymentAccordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default" id="payment-step">
            <div class="panel-heading" role="tab" id="paymentDetailsHeader">
                <h4 class="panel-title">
                    <a class="collapsed" role="button" <?php echo($cartToggleAttribute);?> data-parent="#cartPaymentAccordion" href="#paymentDetailsModule" aria-expanded="false" aria-controls="paymentDetailsModule">
                        Payment
                        <span class="step-options">
                            <i class="material-icons text-yellow stepComplete tsz-hidden" aria-hidden="true">check_circle</i>
                            <i class="fa fa-chevron-down"></i>
